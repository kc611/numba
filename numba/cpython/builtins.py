...
def bool_is_impl(context, builder, sig, args):
    ...
    _arg1 = context.cast(builder, arg1, arg1_type, types.Baseboolean)
    _arg2 = context.cast(builder, arg2, arg2_type, types.Baseboolean)
    eq_impl = context.get_function(
        operator.eq,
        typing.signature(types.Baseboolean, types.Baseboolean, types.Baseboolean)
    )
...
def do_minmax(context, builder, argtys, args, cmpop):
    ...
    def binary_minmax(accumulator, value):
        ...
        cmpsig = typing.signature(types.Baseboolean, ty, ty)
