...
class ValueTypingTestBase(object):
    ...
    def check_datetime_values(self, func):
        ...
        """
        self._base_check_datetime_values(func, np.datetime64, npy_types.NPDatetime)
...
class TestUFuncs(TestCase):
    ...
    def test_ufunc_find_matching_loop(self):
        ...
        check_exact(np_add, (npy_types.NPTimedelta('s'), npy_types.NPTimedelta('s')),
                    'mm->m', output_types=(npy_types.NPTimedelta('s'),))
        check_exact(np_add, (npy_types.NPTimedelta('ms'), npy_types.NPDatetime('s')),
                    'mM->M', output_types=(npy_types.NPDatetime('ms'),))
        check_exact(np_add, (npy_types.NPDatetime('s'), npy_types.NPTimedelta('s')),
                    'Mm->M', output_types=(npy_types.NPDatetime('s'),))
        check_exact(np_add, (npy_types.NPDatetime('s'), npy_types.NPTimedelta('')),
                    'Mm->M', output_types=(npy_types.NPDatetime('s'),))
        check_exact(np_add, (npy_types.NPDatetime('ns'), npy_types.NPTimedelta('')),
                    'Mm->M', output_types=(npy_types.NPDatetime('ns'),))
        check_exact(np_add, (npy_types.NPTimedelta(''), npy_types.NPDatetime('s')),
                    'mM->M', output_types=(npy_types.NPDatetime('s'),))
        check_exact(np_add, (npy_types.NPTimedelta(''), npy_types.NPDatetime('ns')),
                    'mM->M', output_types=(npy_types.NPDatetime('ns'),))
        ...
        # No match
        check_no_match(np_add, (npy_types.NPDatetime('s'), npy_types.NPDatetime('s')))
